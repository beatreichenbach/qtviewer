...
class Viewer(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        icon = QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.SP_BrowserReload)
        self.refresh_btn.setIcon(icon)
        header_lay.addWidget(self.refresh_btn)

        # pause
        self.pause_btn = QtWidgets.QPushButton()
        icon = QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.SP_MediaPause)
